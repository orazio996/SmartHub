 ...
 */
public class Serranda implements Runnable, DispositivoSimulabile{
	...
	public Serranda(int porta, String MAC, String tipo, String marca, String modello) {
		this.porta = porta;
		this.MAC = MAC;
		this.tipo = tipo;
		this.marca = marca;
