...
public class Main {
    ...
    public static void main(String[] args) {
    	...
    	final int portaMonitoraggio = 5000;
        ...
        Dispositivo lampadaStudio = new Dispositivo("LampadaStudio", "127.0.0.1:8081", descLamp1);
        ...
        descParamsTerm.put("temperatura", new DescParametro("temperatura", "float", "℃", false, "0", "50", List.of())); 
     ...
     // mock setup termostato
        Map<String, DescParametro> descParamsSens = new HashMap<>();
        descParamsSens.put("power", new DescParametro("power", "string", "", false, "", "", List.of("ON","OFF"))); 
        descParamsSens.put("temperatura", new DescParametro("temperatura", "float", "℃", true, "0", "50", List.of()));
        DescDispositivo descSens = new DescDispositivo("Sampsung", "Termostato", "SuperWarm 2000X", descParamsSens);
        Dispositivo sensoreTemp = new Dispositivo("SensoreTemp", "127.0.0.1:8091", descSens);
        ...
        registro.addTarget(sensoreTemp);
        ...
        ControllerTargets controllerTargets = new ControllerTargets(registro, servizioRete);
        ...
        // avvio ui
        ConsoleUI ui = new ConsoleUI(controllerTargets, controllerRoutines, registro, motoreRoutine);
        ui.start();
    }
}